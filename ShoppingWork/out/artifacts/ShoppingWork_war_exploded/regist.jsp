...
<div class="content">
    <div class="neibu">
        ...
        <div id="rights">
        <p>客官，欢迎您的到来！</p>
        <form action="regist" method="post" class="form" onsubmit="return regist()">
            <p><span class="text">昵称：</span><input id="namers" type="text" name="username" onblur="userNameBlur()"/> <b
                    id="ckuser" style="color: red"></b></p>
            <p><span class="text">性别：</span><input  type="radio" name="sex" onblur="userNameBlur()"value="男" checked/> 男
                <input  type="radio" name="sex" onblur="userNameBlur()"value="女"/> 女
            </p>

            <p><span class="text">密码：</span><input id="pwdrs" type="password" name="password1" onblur="pwdBlur()"/><b
                    id="ckpwda" style="color: red"></b></p>
            <p><span class="text">确认密码：</span><input id="ckpwdrs" type="password" name="password2"
                                                     onblur="ckpwdBlur()"/><b id="ckpwdb" style="color: red"></b></p>
